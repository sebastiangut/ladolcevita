      ...
      <div className="relative z-10 w-full max-w-[600px] px-4">
        ...
        {currentPhase === 0 && (
          <div className="flex flex-col items-center space-y-8">
            <div className="flex flex-col md:flex-row items-center md:space-x-12 space-y-6 md:space-y-0">
              {showCine && (
                <img 
                  src="/images/splash/01-cine-removebg-preview.png" 
                  alt="CINE"
              ...
              {showMananca && (
                <img 
                  src="/images/splash/02-mananca-removebg-preview.png" 
                  alt="MĂNÂNCĂ"
                  className="animate-fadeInSmooth h-24 md:h-32 object-contain"
                />
              )}
              {showBine1 && (
                <img 
                  src="/images/splash/03-bine-removebg-preview.png" 
                  alt="BINE"
                  className="animate-fadeInSmooth h-24 md:h-32 object-contain"
                />
              )}
        ...
        {currentPhase === 1 && (
          <div className="flex flex-col items-center space-y-8">
            <div className="flex flex-col md:flex-row items-center md:space-x-12 space-y-6 md:space-y-0">
              {showTraieste && (
                <img 
                  src="/images/splash/04-traieste-removebg-preview.png" 
                  alt="TRĂIEȘTE"
                  className="animate-fadeInSmooth h-24 md:h-32 object-contain"
                />
              )}
              {showBine2 && (
                <img 
                  src="/images/splash/05-bine-removebg-preview.png" 
                  alt="BINE"
                  className="animate-fadeInSmooth h-24 md:h-32 object-contain"
                />
              )}
        ...
        {currentPhase === 2 && (
          <div className="flex items-center justify-center">
            {showLogo && (
              <img 
                src="/images/splash/07-ladolcevita-removebg-preview.png" 
                alt="La Dolce Vita"
