// Pizza image paths from public directory
const pizza01 = '/images/pizza/01. Pizza Salami ( sos roșii, mozzarella, salam, măsline )_web.png';
const pizza02 = '/images/pizza/02. Pizza Funghi ( sos roșii, mozzarella, ciuperci )_web.png';
const pizza03 = '/images/pizza/03. Pizza Capriciosa ( sos roșii, oregano, mozzarella, șuncă, salam )_web.png';
const pizza04 = '/images/pizza/04. Pizza Tărănească ( sos roșii, mozzarella, bacon, ceapă, porumb )_web.png';
const pizza05 = '/images/pizza/05. Pizza Salame Piccante ( sos roșii, mozzarella, salam picant )_web.png';
const pizza06 = '/images/pizza/06. Pizza Diavola ( sos roșii, oregano, peperoncini, mozzarella, salam picant )_web.png';
const pizza07 = '/images/pizza/07. Pizza Prosciutto Salami Funghi ( sos roșii, mozzarella, șuncă, salam, ciuperci )_web.png';
const pizza08 = '/images/pizza/08. Pizza Prosciutto e Salami ( sos roșii, mozzarella, șuncă, salam )_web.png';
const pizza09 = '/images/pizza/09. Pizza Prosciutto ( sos roșii, mozzarella, șuncă, măsline )_web.png';
const pizza10 = '/images/pizza/10. Pizza Montana ( sos roșii, mozzarella, șuncă, bacon, ciuperci )_web.png';
const pizza11 = '/images/pizza/11. Pizza Prosciutto e Funghi ( sos roșii, mozzarella, șuncă, ciuperci, măsline )_web.png';
const pizza12 = '/images/pizza/12. Pizza Funghi con Porcini ( sos roșii, mozzarella, șuncă, funghi con porcini, măsline )_web.png';
const pizza13 = '/images/pizza/13. Pizza California ( sos roșii, mozzarella, piept de pui, ardei, porumb )_web.png';
const pizza14 = '/images/pizza/14. Pizza Quattro Stagioni ( sos de roșii, mozzarella, șuncă, ciuperci, anghinare, măsline felii )_web.png';
const pizza15 = '/images/pizza/15. Pizza Quattro Formaggi ( sos roșii, mozzarella, cașcaval afumat, brie, gorgonzola )_web.png';
const pizza16 = '/images/pizza/16. Pizza Prosciutto Crudo ( sos roșii, mozzarella, crudo )_web.png';
const pizza17 = '/images/pizza/17. Pizza Gorgo e Crudo ( sos roșii, mozzarella, gorgonzola, crudo )_web.png';
const pizza18 = '/images/pizza/18. Pizza Crudo e Rucola ( sos roșii, mozzarella, crudo, rucola )_web.png';
const pizza19 = '/images/pizza/19. Pizza Crudo e Brie ( sos roșii, mozzarella, brie, crudo )_web.png';
const pizza20 = '/images/pizza/20. Pizza Speck ( sos roșii, mozzarella, speck )_web.png';
const pizza21 = '/images/pizza/21. Pizza Calabrese ( sos roșii, mozzarella, salam picant, gorgonzola, anghinare )_web.png';
const pizza22 = '/images/pizza/22. Pizza Canibale ( sos roșii, mozzarella, șuncă, bacon, salam, carnați )_web.png';
const pizza23 = '/images/pizza/23. Pizza La Dolce Vita ( sos roșii, mozzarella, șuncă, salam, gorgonzola )_web.png';
const pizza24 = '/images/pizza/24. Pizza Carbonara ( sos alb smantană cu ou, mozzarella, bacon, branză dură )_web.png';
const pizza25 = '/images/pizza/25. Pizza Tartufata ( sos roșii, cremă de ciuperci cu trufe, mozzarella, speck, roșii proaspete )_web.png';
const pizza26 = '/images/pizza/26. Pizza Mascarpone ( sos roșii, mozzarella, mascarpone, carnați, ardei, roșii )_web.png';
const pizza27 = '/images/pizza/27. Pizza Sfiziosa (sos roșii, mozzarella, bacon, ceapă, parmezan )_web.png';
const pizza28 = '/images/pizza/28. Pizza Tonno ( sos roșii, oregano, mozzarella, ton )_web.png';
const pizza29 = '/images/pizza/29. Pizza Palermo ( sos roșii, mozzarella, ton, ceapă, masline )_web.png';
const pizza30 = '/images/pizza/30. Pizza Romană ( sos roșii, busuioc, mozzarella, anșoa, capere )_web.png';
const pizza31 = '/images/pizza/31. Pizza Albă - Pizza Brie e Bacon ( mozzarella, brie, bacon, roșii proaspete )_web.png';
const pizza32 = '/images/pizza/32. Pizza Roșie - Pizza Siciliană ( sos roșii, busuioc, anșoa, roșii proaspete )_web.png';
const pizza33 = '/images/pizza/33. Pizza Margherita ( sos roșii, busuioc, mozzarella, roșii proaspete )_web.png';
const pizza34 = '/images/pizza/34. Pizza de Post - Vegetală ( sos roșii, ciuperci, ardei, porumb, măsline )_web.png';
